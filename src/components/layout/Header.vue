<template>
  ...
  <div class="collapse" id="navbarToggleExternalContent">
    <div class="bg-dark p-4">
      ...
      <span class="text-muted">Accessibility settings selectors</span>
    </div>
  </div>
  ...
  <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container-fluid">
        <router-link class="navbar-brand" to="/">AbilityPay</router-link>
           <button type="button" class="btn btn-secondary my-2" data-toggle="collapse" data-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle accessibility settings">
